...
export default function DondeCuando() {
  return (
    <div className="flex flex-col items-center justify-center w-screen">
      <div
        className={`${cinzelDecorative.className} text-[#B29566] flex flex-col justify-center items-center w-screen py-6 bg-texturabeige bg-opacity-10 overflow-hidden`}
      >
        <h2 className="text-2xl font-bold pb-6">¿Dónde y cuando?</h2>
        <div className="flex flex-col items-center justify-center w-[95%] py-6 shadow-lg shadow-[#3d3838] bg-white rounded-lg text-[#B29566] sm:w-[50%]">
          ...
          <div className="flex items-center justify-center w-60 text-lg border-2 border-[#BAA37D] bg-[#e7dfc0] rounded-md px-4 py-2 hover:bg-white">
            <Link
